...
namespace Medine\Tests\Shared\Infrastructure\PhpUnit\Comparator;

use Medine\Shared\Domain\Aggregate\AggregateRoot;
use Medine\Tests\Shared\Domain\TestUtils;
...
final class AggregateRootArraySimilarComparator extends Comparator
{
    ...
    {
        $exists = function (AggregateRoot $expected) use ($actual, $actualArray) {
            return any(
